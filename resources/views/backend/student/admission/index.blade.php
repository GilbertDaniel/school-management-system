                    ...
                    <div class="col-12">
                        <div class="box">
                            <div class="box-header with-border">
                                ...
                                <a href="{{route('student.admission.create')}}" style="float: right;"
                                    class="btn btn-rounded btn-success mb-5"> Add Admission </a>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                                ...
                                                @foreach ($allData as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a target="_blank" title="Generate PDF"
                                                                href="{{ route('student.admission.show', $value->student_id) }}"
